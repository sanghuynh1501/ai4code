...
from config import (BS, CODE_MARK_PATH, CODE_MARK_RANK_PATH, DATA_DIR, EPOCH, MARK_PATH, NW, SIGMOID_PATH,
                    accumulation_steps)
from dataset import MarkdownOnlyDataset, SigMoidDataset
from helper import cal_kendall_tau, cal_kendall_tau_rank, get_features_mark, get_features_new, get_features_val, markdown_validate, sigmoid_validate, validate, validate_rank
from loss import BinaryFocalLossWithLogits
from model import MarkdownModel, MarkdownOnlyModel, MarkdownRankModel, SigMoidModel
...
train_fts, all_labels = get_features_new(train_df, 'sigmoid')
...
def train(model, train_loader, val_loader, epochs):
    ...
    cal_kendall_tau_rank(val_df, score, mark_dict, relative, df_orders)
